...
public class MainMenuGUI : MonoBehaviour {
	void OnGUI () {
		...
		if(GUI.Button(new Rect((Screen.width-200)/2-200,(Screen.height-500)/2,200,400), "Nemesis mode\n Competitive game\n Score 2000 total points and be the last player alive to win.")){
			Application.LoadLevel("NemesisTest");
		}
		if(GUI.Button(new Rect((Screen.width-200)/2+200,(Screen.height-500)/2,200,400), "Sidekick mode\n Cooperative game\n Score 5000 total combined points and survive both players to win.")){
